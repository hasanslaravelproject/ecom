...
class OrderController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $orderCategories = OrderCategory::pluck('name', 'id');
        $menuTypes = MenuType::pluck('id', 'id');

        return view(
            'app.orders.create',
            compact('products', 'orderCategories', 'menuTypes')
        );
    }
    ...
    public function edit(Request $request, Order $order)
    {
        ...
        return view(
            'app.orders.edit',
            compact('order', 'products', 'orderCategories', 'menuTypes')
        );
    }
